...
// INSERT POINT: _refresh
    ...
    scrollingTo: function (x, y, time, easing) {
        time = this.options.scrollTime;
...
(function (window, document, $) {
    $.fn.fp_scrolloverflow = (function() {
        ...
        */
		...
		// hf
		scrollable.trigger("scrolled", [(0 - scroller.y) + scrollable.scrollTop() + 1 + scrollable.innerHeight() >= scrollable[0].scrollHeight]);
